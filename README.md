# SV05
Release version 1 of my custom build of Marlin 2.1.1 for the Sovol SV05 with Creality v4.2.2 board.
...
After flashing, check Info -> Printer Info on the LCD — it should show 2.1.1-SV05-v1 confirming the flash worked.
